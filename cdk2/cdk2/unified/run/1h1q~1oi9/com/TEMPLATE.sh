...
timask2         = '@46-91'        ! TI region 2
crgmask         = ""
scmask1         = '@39-41'        ! softcore region 1
scmask2         = '@84-86,91'        ! softcore region 2
...
#!/usr/bin/env bash
#SBATCH --job-name="com_eq_1h1q~1oi9.slurm"
...
### CUDA MPS # BEGIN ###
temp_path=/tmp/temp_com_1h1q~1oi9
mkdir -p \${temp_path}
...
#!/usr/bin/env bash
#SBATCH --job-name="com_pr_1h1q~1oi9.slurm"
