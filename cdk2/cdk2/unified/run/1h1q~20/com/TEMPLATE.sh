...
#!/usr/bin/env bash
#SBATCH --job-name="com_eq_1h1q~20.slurm"
#SBATCH --output="eq_1h1q~20.slurm.slurmout"
#SBATCH --error="eq_1h1q~20.slurm.slurmerr"
...
### CUDA MPS # BEGIN ###
temp_path=/tmp/temp_com_1h1q~20
mkdir -p \${temp_path}
...
#!/usr/bin/env bash
#SBATCH --job-name="com_pr_1h1q~20.slurm"
#SBATCH --output="pr_1h1q~20.slurm.slurmout"
#SBATCH --partition=rtx
#SBATCH --nodes=1
#SBATCH --ntasks-per-node=${#lams[@]}
##SBATCH --gres=gpu:4
