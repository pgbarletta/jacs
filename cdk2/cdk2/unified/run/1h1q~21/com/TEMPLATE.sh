...
scmask2         = '@84-86,91-94'        ! softcore region 2
...
#!/usr/bin/env bash
#SBATCH --job-name="com_eq_1h1q~21.slurm"
#SBATCH --output="eq_1h1q~21.slurm.slurmout"
#SBATCH --error="eq_1h1q~21.slurm.slurmerr"
...
### CUDA MPS # BEGIN ###
temp_path=/tmp/temp_com_1h1q~21
mkdir -p \${temp_path}
...
#!/usr/bin/env bash
#SBATCH --job-name="com_pr_1h1q~21.slurm"
#SBATCH --output="pr_1h1q~21.slurm.slurmout"
#SBATCH --partition=rtx
#SBATCH --nodes=1
#SBATCH --ntasks-per-node=${#lams[@]}
##SBATCH --gres=gpu:4
