...
timask2         = '@46-94'        ! TI region 2
crgmask         = ""
scmask1         = '@39-41'        ! softcore region 1
scmask2         = '@84-85,90-94'        ! softcore region 2
...
#!/usr/bin/env bash
#SBATCH --job-name="com_eq_1h1q~22.slurm"
#SBATCH --output="eq_1h1q~22.slurm.slurmout"
#SBATCH --error="eq_1h1q~22.slurm.slurmerr"
...
### CUDA MPS # BEGIN ###
temp_path=/tmp/temp_com_1h1q~22
mkdir -p \${temp_path}
...
#!/usr/bin/env bash
#SBATCH --job-name="com_pr_1h1q~22.slurm"
#SBATCH --output="pr_1h1q~22.slurm.slurmout"
#SBATCH --partition=rtx
#SBATCH --nodes=1
#SBATCH --ntasks-per-node=${#lams[@]}
##SBATCH --gres=gpu:4
