...
timask1         = '@1-50'        ! TI region 1
timask2         = '@51-106'        ! TI region 2
crgmask         = ""
scmask1         = '@40,45-50'        ! softcore region 1
scmask2         = '@90,95-106'        ! softcore region 2
...
#!/usr/bin/env bash
#SBATCH --job-name="com_eq_1h1s~29.slurm"
#SBATCH --output="eq_1h1s~29.slurm.slurmout"
#SBATCH --error="eq_1h1s~29.slurm.slurmerr"
...
### CUDA MPS # BEGIN ###
temp_path=/tmp/temp_com_1h1s~29
mkdir -p \${temp_path}
...
#!/usr/bin/env bash
#SBATCH --job-name="com_pr_1h1s~29.slurm"
#SBATCH --output="pr_1h1s~29.slurm.slurmout"
#SBATCH --partition=rtx
#SBATCH --nodes=1
#SBATCH --ntasks-per-node=${#lams[@]}
##SBATCH --gres=gpu:4
