...
timask1         = '@1-46'        ! TI region 1
timask2         = '@47-95'        ! TI region 2
crgmask         = ""
scmask1         = '@40,46'        ! softcore region 1
scmask2         = '@86,92-95'        ! softcore region 2
...
#!/usr/bin/env bash
#SBATCH --job-name="com_eq_1oi9~26.slurm"
#SBATCH --output="eq_1oi9~26.slurm.slurmout"
#SBATCH --error="eq_1oi9~26.slurm.slurmerr"
...
### CUDA MPS # BEGIN ###
temp_path=/tmp/temp_com_1oi9~26
mkdir -p \${temp_path}
...
#!/usr/bin/env bash
#SBATCH --job-name="com_pr_1oi9~26.slurm"
