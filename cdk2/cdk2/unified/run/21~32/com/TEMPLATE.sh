...
timask1         = '@1-49'        ! TI region 1
timask2         = '@50-103'        ! TI region 2
crgmask         = ""
scmask1         = '@39-40,46-49'        ! softcore region 1
scmask2         = '@92-102'        ! softcore region 2
...
#!/usr/bin/env bash
#SBATCH --job-name="com_eq_21~32.slurm"
...
#!/usr/bin/env bash
#SBATCH --job-name="com_pr_21~32.slurm"
#SBATCH --output="pr_21~32.slurm.slurmout"
#SBATCH --partition=rtx
#SBATCH --nodes=1
#SBATCH --ntasks-per-node=${#lams[@]}
##SBATCH --gres=gpu:4
